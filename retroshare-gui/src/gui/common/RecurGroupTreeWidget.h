...
#ifndef RECURGROUPTREEWIDGET_H
#define RECURGROUPTREEWIDGET_H
...
class RecurGroupTreeWidget : public QWidget
{
	Q_OBJECT
...
public:
	RecurGroupTreeWidget(QWidget *parent = 0);
	~RecurGroupTreeWidget();
	...
	void fillGroupItems(QTreeWidgetItem *categoryItem, const QList<GroupRecurItemInfo> &itemList);
